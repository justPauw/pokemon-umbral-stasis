  ...
  <div>
    ...
    <div style="display: flex; flex-direction: row; column-gap: 3rem; alignt-items: center; ">
      ...
      <div style="display: flex; flex-direction: row; align-items: center; font-size: 16px">
        ...
        /<a href='' title="Whenever a grass-type move hits this Pokemon, its Attack rises one stage, negating any other effect on it.">Hidden: Sap-sipper</a>
      </div>
    </div>
  </div>
</div>
...
| Route | Area | Encounter Rate | Extra Instructions |
        | -- | -- | -- | -- |
        	| Lakeview Tunnel | Cave | 30 |  |
	| Flairtooth Cave | Cave | 25 |  |
